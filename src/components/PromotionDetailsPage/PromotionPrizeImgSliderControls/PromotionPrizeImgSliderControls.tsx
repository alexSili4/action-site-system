...
import { Container, SliderBtn } from './PromotionPrizeImgSliderControls.styled';
import { theme } from '@/constants';

const PromotionPrizeImgSliderControls: FC = () => {
...
export default PromotionPrizeImgSliderControls;
